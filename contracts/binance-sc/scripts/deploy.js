...
async function main() {
  ...
  console.log("BSC20Safe deployed to:", safeContract.address);
  ...
  console.log("Bridge deployed to BSC:", bridgeContract.address);
  ...
  data = {
    bsc20Token: AFCContract.address,
    bsc20Safe: safeContract.address,
